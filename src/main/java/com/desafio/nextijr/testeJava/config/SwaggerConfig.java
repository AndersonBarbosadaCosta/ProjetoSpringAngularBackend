package com.desafio.nextijr.testeJava.config;
...
public class SwaggerConfig {
    ...
    public Docket appConfigDocs() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.desafio.nextijr.testeJava.resource"))
    ...
    private ApiInfo infoDocs() {
        ...
        ApiInfo apiInfo = new ApiInfo("REST API Gerenciamento de Pedidos", "Application REST with Spring Boot",
                "1.0", "terms",
